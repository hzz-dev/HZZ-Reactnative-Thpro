  ...
  render() {
    return (
      <View style={{ flexDirection: "row", width: "80%", justifyContent: "space-around" }} >
        ...
        >
          <View style={{
            width: pxToDp(50), height: pxToDp(50), borderRadius: pxToDp(35),
            backgroundColor: "red", justifyContent: "center", alignItems: "center"
          }} >
            <Svg width="40" height="40" fill="#fff" svgXmlData={tanhua} />
          </View>
          <Text style={{ fontSize: pxToDp(14), marginTop: pxToDp(4), color: "#ffffff9a" }} >探花</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{ alignItems: "center" }}
        ...
        >
          ...
          <Text style={{ fontSize: pxToDp(14), marginTop: pxToDp(4), color: "#ffffff9a" }} >搜附近</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{ alignItems: "center" }}
        ...
        >
          ...
          <Text style={{ fontSize: pxToDp(14), marginTop: pxToDp(4), color: "#ffffff9a" }} >测灵魂</Text>
        </TouchableOpacity>
      </View>
    );
  }
