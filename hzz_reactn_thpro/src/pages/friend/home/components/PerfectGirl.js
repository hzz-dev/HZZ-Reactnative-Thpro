    ...
    return (
      <View style={{ flexDirection: "row" }}>
        ...
        <View style={{ position: "relative" }} >
          <Image
            style={{ width: pxToDp(80), height: pxToDp(80), margin: 10 }}
            source={{ uri: BASE_URI + perfectGirl.header }} />
          <View
            style={{
              width: pxToDp(60), height: pxToDp(20), marginLeft: 10, backgroundColor: "#b564bf",
              justifyContent: "center", alignItems: "center",
              position: "absolute", left: 0, bottom: pxToDp(10)
            }}
          >
            <Text style={{ color: "#fff", fontSize: pxToDp(13) }}>今日佳人</Text>
          </View>
        </View>
        {/* 左边图片 结束 */}
        {/* 右边内容 开始 */}
